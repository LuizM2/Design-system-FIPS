        ...
        <Section n="04" title="Hierarquia visual" desc="Exemplo de uma página real com a tipografia correta aplicada em cada nível.">
          <DSCard mob={mob}>
            <div style={{background:C.bg,borderRadius:"10px 10px 10px 18px",padding:mob?16:24,border:`1px solid ${C.cardBorder}`}}>
              ...
              <div style={{fontSize:12,color:C.cinzaChumbo,fontFamily:Fn.title,fontWeight:400}}>DS-FIPS v2.0 · Excelência sobre trilhos <span style={{fontSize:9,color:C.textLight,fontFamily:Fn.mono}}>text-xs · Saira 400 12px</span></div>
            </div>
          </DSCard>
        </Section>

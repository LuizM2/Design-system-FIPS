...
Tooltip com 6 variantes, 4 posições, arrow, delay, suporte a título rich.
...
<Tooltip content="Info"><span>Hover</span></Tooltip>
```
...
- `Tooltip.tsx` — 82 linhas, self-contained, sem dependências externas
- Origem: `TooltipDoc.tsx` no Design System FIPS

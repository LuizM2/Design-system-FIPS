...
Tabs com indicador deslizante laranja 3px. Ícones, contadores, disabled. Padrão principal do DS-FIPS.
...
<TabsUnderline tabs={[{label:"Geral"},{label:"Config"}]} active={0} onChange={setActive} />
```
...
- `TabsUnderline.tsx` — 89 linhas, self-contained, sem dependências externas

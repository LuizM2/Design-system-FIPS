...
Tabs com borda sutil, suporta orientação vertical com borda lateral laranja 2px.
...
<TabsBordered tabs={[{label:"Perfil"}]} active={0} onChange={setActive} vertical />
```
...
- `TabsBordered.tsx` — 26 linhas, self-contained, sem dependências externas

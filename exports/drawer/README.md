...
Painel lateral deslizante (slide-in), overlay, ESC fecha. Suporta right/left/bottom/top.
...
<Drawer open={open} onClose={close} title="Detalhes">Conteúdo</Drawer>
```
...
- `Drawer.tsx` — 76 linhas, self-contained, sem dependências externas
- Origem: `DrawerDoc.tsx` no Design System FIPS

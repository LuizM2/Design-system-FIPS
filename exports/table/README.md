...
Tabela com sorting asc/desc por coluna, paginação, striped rows, hover, render customizado, footer.
...
<DSTable columns={[{key:"nome",label:"Nome"}]} data={[{nome:"Item"}]} />
```
...
- `DSTable.tsx` — 132 linhas, self-contained, sem dependências externas
- Origem: `TableDoc.tsx` no Design System FIPS

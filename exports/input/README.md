...
Campo input com label, ícone, password toggle, clear button, 3 tamanhos, estados error/disabled/readOnly.
...
- `Input.tsx` — 152 linhas, self-contained, sem dependências externas
- Origem: `InputDoc.tsx` no Design System FIPS

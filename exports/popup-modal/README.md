...
Modal redimensionável com 3 tamanhos: Normal (480px), Grande (720px), Tela Cheia (92vw). Botão toggle no header.
...
<PopupModal open={open} onClose={close} title="Form">{({size,isWide})=>(<div>...</div>)}</PopupModal>
```
...
- `PopupModal.tsx` — 141 linhas, self-contained, sem dependências externas

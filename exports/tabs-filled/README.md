...
Tabs com fundo azul na aba ativa, container cinza, sombra. Para filtros e categorias.
...
<TabsFilled tabs={[{label:"Todas",count:23}]} active={0} onChange={setActive} />
```
...
- `TabsFilled.tsx` — 25 linhas, self-contained, sem dependências externas

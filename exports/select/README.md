...
Dropdown select customizado com opções, ícone, estados error/disabled, modo compacto.
...
<DSSelect label="Tipo" options={["Opção 1","Opção 2"]} />
```
...
- `DSSelect.tsx` — 107 linhas, self-contained, sem dependências externas
- Origem: `SelectDoc.tsx` no Design System FIPS

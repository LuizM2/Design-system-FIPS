...
Badge/tag com variantes semânticas (sucesso, atenção, crítico, info, ouro), dot indicator, contador, removível.
...
<Badge variant="sucesso">Aprovado</Badge>
```
...
- `Badge.tsx` — 99 linhas, self-contained, sem dependências externas
- Origem: `BadgeDoc.tsx` no Design System FIPS
